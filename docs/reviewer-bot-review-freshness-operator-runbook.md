...
- Deferred review dismissal replay requires `source_dismissed_at` from the observer payload or exact live `dismissed_at`; otherwise it remains diagnostic-only and must not be replayed manually.
